...
export class QueryConsole {
    ...
    private autoClear = workspace.getConfiguration().get('k9-client.output.autoClear') as boolean;
    private includeQuery = workspace.getConfiguration().get('k9-client.output.includeQuery') as boolean;
